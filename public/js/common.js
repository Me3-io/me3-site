/**
 *	Me3 - Creative Portfolio Agency HTML Template
 *	Version: 1.0
 *	Author: bslthemes
 *	Author URL: http://themeforest.net/user/bslthemes
 *	Copyright © Me3 by bslthemes. All Rights Reserved.
 **/
...
(function ($) {
  ...
  /**
	...
	**/
  Splitting({ by: "lines" });
  ScrollOut({ targets: "[data-me3-scroll]", once: true });

  $(".word").wrap("<span></span>");
  $("[data-me3-overlay]").append('<div class="me3-overlay"></div>');

  /**
		Header Sticky
	**/
  if ($(".me3-header").length) {
    var new_scroll_position = 0;
    var last_scroll_position;
    $(window).on("scroll", function () {
      var header = $(".me3-header");
  ...
  /**
		Header Menu Button
	**/
  $(".me3-menu-btn").on("click", function () {
    var obj = $(this);
    if (obj.hasClass("btn--active")) {
      $("body").removeClass("me3--noscroll");
      $(".me3-header").removeClass("header--active");
      obj.removeClass("btn--active");
      obj.addClass("me3--notouch");
      obj.parent().find(".me3-menu-popup").removeClass("menu--ready");
      obj.parent().find(".me3-menu-container").addClass("me3--noscroll");
      setTimeout(function () {
        obj.parent().find(".me3-menu-popup").removeClass("menu--open");
      }, 300);
      setTimeout(function () {
        obj.removeClass("me3--notouch");
        obj.parent().find(".me3-menu-popup").removeClass("menu--visible");
      }, 1600);
    } else {
      $("body").addClass("me3--noscroll");
      $(".me3-header").addClass("header--active");
      obj.addClass("btn--active");
      obj.addClass("me3--notouch");
      obj.parent().find(".me3-menu-popup").addClass("menu--visible");
      obj.parent().find(".me3-menu-popup").addClass("menu--open");
      setTimeout(function () {
        obj.removeClass("me3--notouch");
        obj.parent().find(".me3-menu-container").removeClass("me3--noscroll");
        obj.parent().find(".me3-menu-popup").addClass("menu--ready");
      }, 600);
    }
    return false;
  });
  ...
  /*
		Top Menu Close
	*/
  $(".me3-menu").on("click", "a", function () {
    if (!$(this).parent().hasClass("menu-item-has-children")) {
      $(".me3-header .me3-menu-btn.btn--active").trigger("click");
    }
  });
  ...
  /*
	...
	*/
  $(".me3-menu").on("click", ".menu-item-has-children > .icon, .dropdown-link > a", function () {
  ...
  if ($(".footer--fixed").length) {
    var footer_fixed = $(".footer--fixed .me3-footer").height();
  ...
  /*
		Intro Style
	*/
  if ($(".me3-intro.intro--black").length) {
    $(".me3-header").addClass("header--white");
  }
  ...
  $(".js-hero-parallax").each(function () {
    ...
    heroParallax.pagepiling({
      ...
      sectionSelector: ".me3-hero-parallax-section",
      afterRender: function () {
        if (heroParallax.find(".me3-hero-parallax-section.active").hasClass("section--dark")) {
          setDark();
        }
      ...
      afterLoad: function (anchorLink, index) {
        var current = heroParallax.find(".me3-hero-parallax-section.active");
  ...
  function setDark() {
    $(".me3-page").addClass("parallax--dark");
    $(".me3-header").removeClass("header--white");
    $(".me3-hero-parallax .me3-prev").removeClass("nav--white");
    $(".me3-hero-parallax .me3-next").removeClass("nav--white");
  }
  function removeDark() {
    $(".me3-page").removeClass("parallax--dark");
    $(".me3-header").addClass("header--white");
    $(".me3-hero-parallax .me3-prev").addClass("nav--white");
    $(".me3-hero-parallax .me3-next").addClass("nav--white");
  }
  ...
  $(".js-hero-slider").each(function () {
    ...
    heroMainSwiper.find(".me3-paginations-container").append('<div class="swiper-nav-active"></div>');
  ...
  $(".js-blog-carousel").each(function () {
    ...
    blogSwiper.parent().find(".me3-paginations-container").append('<div class="swiper-nav-active"></div>');
  ...
  $(".js-history-slider").each(function () {
    ...
    hisSwiper.find(".me3-paginations-container").append('<div class="swiper-nav-active"></div>');
  ...
  /*
	...
	*/
  $(".me3-play-btn").on("click", function () {
  ...
  /*
		- Services Hover
	*/
  $(".me3-service-grid-item.active--default").each(function () {
    $(this)
      .closest(".me3-services-grid-fw")
      .hover(
        function () {
          if ($(this).find(".me3-service-grid-item").hasClass("active--default")) {
            $(this).find(".me3-service-grid-item").removeClass("active");
          }
        },
        function () {
          if ($(this).find(".me3-service-grid-item").hasClass("active--default")) {
            $(this).find(".me3-service-grid-item.active--default").addClass("active");
          }
        }
      );
  });
  ...
  /*
		- Number Text
	*/
  $(".me3-circle-text .label").each(function () {
    $(this).html(
      $(this)
        .text()
        .split("")
  ...
  /*
	...
	*/
  if ($(".me3-showcase-items").length) {
    $(".me3-showcase-items").find(".me3-showcase-item:first-child").addClass("hover");
  }
  $(".me3-showcase-item").mouseenter(function () {
    var obj = $(this);
    obj.closest(".me3-showcase-items").find(".me3-showcase-item").removeClass("hover");
    obj.addClass("hover");
  });
  ...
  /*
	...
	*/
  if ($(window).width() > 767) {
    if ($(".me3-services-showcase").length) {
      $(".me3-services-showcase").find(".items ul li:first-child").addClass("hover");
    }
    $(".me3-services-showcase .items ul li .title").mouseenter(function () {
  ...
  /**
		- Video
	**/
  $(".me3-video").on("click", ".play, .image", function () {
    $(this).closest(".me3-video").addClass("active");
    var iframe = $(this).closest(".me3-video").find(".js-video-iframe");
  ...
  /*
		- Me3 Button
	*/
  $("button.me3-btn.me3-hover-btn").each(function () {
  ...
  $(".pager").each(function () {
    ...
    btn_next.html("<i></i>");
    btn_prev.html("<i></i>");
    btn_next.addClass("me3-next me3-hover-2");
    btn_prev.addClass("me3-prev me3-hover-2");
  });

  /*
		- Me3 Portfolio
	*/
  var $container = $(".me3-portfolio-items");
  ...
  /*
		- Me3 Filter
	*/
  $(".me3-filter-nav-active").each(function () {
    $(this).css({
      width: $(this).closest(".me3-filter.filter--default").find(".item--active").parent().width() + 6 + "px",
    });
  });
  $(".me3-filter").on("click", "button", function () {
    var filterValue = $(this).attr("data-filter");
    $container.isotope({ filter: filterValue });
    $(filterValue).find(".image").attr("data-scroll", "in");
    $(filterValue).find(".splitting").attr("data-scroll", "in");

    $(".me3-filter button").removeClass("item--active");
    $(this).addClass("item--active");

    var current_pos = $(this).closest(".me3-filter.filter--default").find(".item--active").parent().position().left;
    var current_width = $(this).closest(".me3-filter.filter--default").find(".item--active").parent().width();
    $(this)
      .closest(".me3-filter.filter--default")
      .find(".me3-filter-nav-active")
  ...
  /**
		Collapse
	**/
  $(".me3-collapse-item").on("click", ".me3-collapse-btn", function () {
    if ($(this).closest(".me3-collapse-item").hasClass("opened")) {
      $(this).closest(".me3-collapse-item").removeClass("opened");
      $(this).removeClass("active");
      $(this).next().slideUp();
    } else {
      $(this).closest(".me3-collapse-item").addClass("opened");
      $(this).addClass("active");
      $(this).next().slideDown();
    }
  });
